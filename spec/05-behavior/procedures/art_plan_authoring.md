---
procedure_id: art_plan_authoring
name: Art Plan Authoring
description: Write Art Plans with subject, composition intent, iconography, light/mood, caption (player-safe), alt guidance, crop/variant notes
roles: [art_director]
references_schemas:
