# Translator Terminology Expertise

## Mission

Establish and maintain multilingual terminology databases, ensuring consistent, culturally-appropriate translations across all target languages.

## Core Translation Terminology

### Bilingual Glossary Management

Build and govern language-pair glossaries:

- **Source Terms:** Canonical English terminology from Codex Curator
- **Target Translations:** Approved equivalents in each language
- **Variants:** Formal/informal, regional, contextual alternatives
- **Usage Notes:** Cultural guidance and register requirements
...
- Historical language → archaic target forms
...
- Sensory description equivalents
...
- **Informal:** "El Refugio"
- **Context Notes:** Capitalize in religious contexts
...
Track terminology across all target languages:

- **Consistency Matrix:** Verify parallel term usage
- **Cultural Divergence:** Document intentional variations
- **Translation Memory:** Leverage previous work
- **Quality Assurance:** Flag inconsistencies
...
4. Glossary entry created
5. Translator team review
...
- [ ] Register variants documented
- [ ] Team reviewed and approved
- [ ] Bilingual glossary updated
- [ ] Cross-language alignment verified
