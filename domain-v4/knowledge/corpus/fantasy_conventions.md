...
**When to use:** Readers understand the social dynamics.
**When to subvert:** Explore non-European cultures, different tech levels.
...
**Problem:** Reduces cultures to stereotypes.
**Fix:** Show diversity within cultures, mixed communities.
...
- Chosen one narrative is manipulation
- Wrong person was chosen
- Chosen one rejects destiny
- Multiple "chosen ones" in conflict
- Burden causes trauma/resentment

**For Interactive Fiction:**

- Player agency conflicts with predetermined destiny
- Let players explore "what if chosen one failed?"
- Treat prophecy as probability, not certainty
...
- Mentor has ulterior motives
- Mentor is learning alongside student
- Mentor is wrong about crucial things
- Multiple mentors with conflicting advice

**For Interactive Fiction:**

- Mentor relationships affected by choices
- Option to reject mentor's teachings
- Moral choices: follow path or forge your own?
...
**Effective Villain Motivations:**

- Personal vendetta with legitimate grievance
- "Doing evil for good reasons"
- Traumatic backstory explaining actions
- Dark mirror of hero's potential

**For Interactive Fiction:**

- Player might discover villain's perspective
- Choices allowing sympathy or understanding
- Possible redemption arcs based on actions
...
> Raise your shield and wait
> Speak the fire-words
