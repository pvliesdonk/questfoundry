...
# ---------------------------------------------------------------------------
# Exemplar generation (Phase 0b)
# ---------------------------------------------------------------------------


class FillExemplarOutput(BaseModel):
    """Phase 0b structured output: voice exemplar passages.

    Generated by the strong model when corpus-sourced exemplars are
    unavailable. Each passage demonstrates the target voice in a
    ...
    exemplar_passages: list[str] = Field(
        min_length=2,
        max_length=3,
        description="2-3 passages demonstrating the target voice (3-5 sentences each)",
    )
