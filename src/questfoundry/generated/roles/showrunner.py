...
SHOWRUNNER = RoleIR(
    ...
    tools=[
        ...
        RoleToolIR(
            name="create_brief", description="Create a new Brief artifact to define work scope"
        ),
        RoleToolIR(
            name="approve_deliverable", description="Mark a deliverable as approved for publication"
        ),
    ],
    constraints=[
    ...
    prompt_template="""You are the **{{ role.archetype }}**, the strategic leader of QuestFoundry.
