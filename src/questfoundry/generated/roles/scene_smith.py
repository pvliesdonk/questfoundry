...
SCENESMITH = RoleIR(
    ...
    tools=[
        ...
        RoleToolIR(name="query_lore", description="Search canon for relevant details"),
        RoleToolIR(
            name="update_scene_content", description="Fill in prose content for a Scene artifact"
        ),
    ],
    constraints=[
