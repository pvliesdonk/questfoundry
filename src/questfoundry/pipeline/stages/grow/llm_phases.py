...
class _LLMPhaseMixin:
    ...
    async def _phase_9_choices(self, graph: Graph, model: BaseChatModel) -> GrowPhaseResult:
        ...
        if len(orphan_starts) > 1:
            ...
            prologue_id = self.PROLOGUE_ID  # type: ignore[attr-defined]
            graph.create_node(
                prologue_id,
                {
                    "type": "passage",
        ...
        if single_successors:
            ...
            context = {
                "transition_context": compact_items(transition_items, self._compact_config()),  # type: ignore[attr-defined]
    ...
    async def _phase_9b_fork_beats(self, graph: Graph, model: BaseChatModel) -> GrowPhaseResult:
        ...
        context = {
            "stretch_context": compact_items(stretch_items, self._compact_config()),  # type: ignore[attr-defined]
